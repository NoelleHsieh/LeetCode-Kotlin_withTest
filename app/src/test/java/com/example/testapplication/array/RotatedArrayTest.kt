...
class RotatedArrayTest {
    ...
    private val fakeArray3 = intArrayOf(1, 2)
    private val fakeArray4 = intArrayOf(1, 2, 3)
    ...
    private val answerArray1_4 = intArrayOf(4, 5, 6, 7, 1, 2, 3)
    private val answerArray2_1 = intArrayOf(99, -1, -100, 3)
    private val answerArray2_2 = intArrayOf(3, 99, -1, -100)
    private val answerArray3 = intArrayOf(2, 1)
    private val answerArray4 = intArrayOf(2, 3, 1)
...
//        assertArrayEquals(answerArray1_3, rotatedArray.solution(fakeArray1, 3))
        assertArrayEquals(answerArray1_4, rotatedArray.solution(fakeArray1, 4))
//        assertArrayEquals(answerArray2_1, rotatedArray.solution(fakeArray2, 1))
        ...
        assertArrayEquals(answerArray3, rotatedArray.solution(fakeArray3, 3))
        assertArrayEquals(answerArray4, rotatedArray.solution(fakeArray4, 2))
    }
